    ...
    $scope.InsertDMQ = function (type) {
        try {
            ...
            if ($scope.myown == 1) {
                ...
                if ($scope.poanum2 == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.poanum3 == undefined) {
                    alert("Please enter valid data");
                    return false;
            ...
            {
                alert('Based on what we have discussed, is it your understanding that this plan provides coverage for medical AND prescription drugs? "must select Yes"')
                return false;
            }
