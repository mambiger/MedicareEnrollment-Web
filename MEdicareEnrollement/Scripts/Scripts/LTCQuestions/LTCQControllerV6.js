appMedicareEnrollment.controller('LTCQController', function ($scope, $window, $log, $sessionStorage, LTCQService) {
    ...
    $scope.InsertLTCQInfo = function (type) {
        try {
            ...
            if ($scope.CurrentlyResInNHorLT == 1) {
                if ($scope.DateEnteredMonth == undefined) {
                ...
                if ($scope.DateEnteredYear == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.InstitutionName == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.InstitutionAdd1 == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.InstitutionCity == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.InstitutionState == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.InstitutionZIP == undefined) {
                    alert("Please enter valid data");
                    return false;
            ...
            if ($scope.EmergencyContactOption == 1) {
                if ($scope.Emergency_FirstName == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.Emergency_LastName == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.Emergency_Relation == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
            }
            if ($scope.CurrentlyOnMedicalID == 1) {
                if ($scope.MedicalIDPolicyNo == undefined) {
                    alert("Please enter valid data");
                    return false;
