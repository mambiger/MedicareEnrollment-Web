appMedicareEnrollment.controller('GroupCoverageController', function ($scope, $window, $log, $sessionStorage, GroupCoverageService) {
    ...
    $scope.InsertGroupCoverageInfo = function (type) {
        try {
            ...
            if ($scope.YouOrSpouseGroupHealth == 1) {
                if ($scope.CarrierName == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.PolicyNumber == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.CarrierAddress1 == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.CarrierCity == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.CarrierState == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.CarrierZip == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
            }
            if ($scope.OtherPrescription == 1) {
                if ($scope.OtherCoverage == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.OtherPolicyNo == undefined) {
                    alert("Please enter valid data");
                    return false;

                }
                if ($scope.OtherMemberID == undefined) {
                    alert("Please enter valid data");
                    return false;
